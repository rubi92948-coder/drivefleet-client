const Explore = () => {
  const cars = [
    ...
    },
    {
      ...
      name: "Tesla Model S",
      price: "$95/day",
      img: "https://images.unsplash.com/photo-1617704548623-340376564e68?auto=format&fit=crop&w=800&q=80"
    },
    {
      id: 3,
      name: "Audi R8",
    ...
    },
    {
      ...
      name: "Toyota Supra",
      price: "$90/day",
      img: "https://images.unsplash.com/photo-1619767886612-4f2b1a5e9f8c?auto=format&fit=crop&w=800&q=80"
    },
    {
      id: 8,
      name: "Nissan GTR",
      price: "$150/day",
      img: "https://images.unsplash.com/photo-1600706432502-77b3b7f8f6f2?auto=format&fit=crop&w=800&q=80"
    },
    {
      id: 9,
      name: "Ford Mustang",
    ...
    },
    {
      ...
      price: "$170/day",
      img: "https://images.unsplash.com/photo-1605559424771-8f9b2c6a6f9d?auto=format&fit=crop&w=800&q=80"
    },
    {
      id: 12,
      name: "McLaren 720S",
      price: "$250/day",
      img: "https://images.unsplash.com/photo-1549921296-3a6b8a1f1c8d?auto=format&fit=crop&w=800&q=80"
    }
  ];
        ...
        {cars.map((car) => (
          ...
          >
            ...
            <div className="p-5">
              ...
              <button className="mt-4 bg-orange-500 hover:bg-orange-600 px-4 py-2 rounded-lg w-full transition">
                Details
              </button>
            </div>
          </div>
